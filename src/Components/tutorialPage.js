...
return(
  <div>
    <JumbotronPage text="History Database Tutorial"/>
      ...
      <p>Here we'd like to introduce you to the vision for the Global History Database</p>
      <h2>Statistics</h2>
      ...
      <p>The Database will be filterable based on critical events, like World War I and other major historical events, as well as by major cultural and global attributes that are shared across time and space, such as:</p>
      ...
      <li>Natural events like diseases, floods, volcanic eruptions, ice ages</li>
